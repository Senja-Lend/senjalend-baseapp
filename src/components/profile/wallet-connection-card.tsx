...
import CustomWalletButton from "../wallet/custom-wallet-button";
            ...
            <div className="bg-orange-50 rounded-lg p-3 sm:p-4 border border-orange-200">
              ...
              <div className="mt-4 pt-3 border-t border-orange-200">
                <Button
                  onClick={() => disconnect()}
                  variant="outline"
                  className="w-full rounded-lg text-red-600 border-red-200 hover:bg-red-500 hover:text-white text-sm flex items-center justify-center gap-2"
                >
