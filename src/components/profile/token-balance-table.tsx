...
// Shared styles
const CARD_STYLES = "bg-white/80 backdrop-blur-sm border border-sunset-orange shadow-xl";
                  ...
                  <div className="text-2xl font-bold text-blue-700">
                    {isAnyLoading || (conversionLoading && !showTimeoutFallback) ? (
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-xs text-orange-500 mt-1">Estimated rate (exchange rate unavailable)</div>
                      </div>
                    ) : totalUsdtValue > 0 ? (
                      <div className="text-sm">
                        <div className="text-blue-700">≈ {formatLargeNumber(totalUsdtValue.toFixed(6))} USDT value</div>
                        <div className="text-xs text-orange-500 mt-1">Converting to {selectedPool.collateralTokenInfo?.symbol}...</div>
                      </div>
                    ) : (
