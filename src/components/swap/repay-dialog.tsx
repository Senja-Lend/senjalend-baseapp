        ...
        <DialogContent className="max-w-md mx-auto bg-white/95 backdrop-blur-sm border-sunset-orange/30 w-[calc(100vw-2rem)] sm:w-full">
          ...
          <div className="space-y-4">
            ...
            <Card className="p-4 bg-orange-50 border border-orange-200">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Repay by collateral</div>
                </div>
              </div>
            </Card>
            ...
            <div className="space-y-2">
              ...
              <div className="relative bg-orange-50 rounded-lg p-3 border border-orange-200">
                <Input
                  type="number"
                  placeholder="0.00"
                  value={collateralAmount}
                  onChange={(e) => handleCollateralAmountChange(e.target.value)}
                  className="border-0 bg-transparent text-lg font-semibold placeholder:text-gray-400 p-0 h-auto focus-visible:ring-0 text-gray-900"
                />
            ...
            <div className="space-y-2">
              <Button
                ...
                className="w-full h-12 text-sm font-semibold bg-orange-500 hover:bg-orange-600 text-white disabled:opacity-50 rounded-xl shadow-lg"
              >
            ...
            <div className="space-y-2">
              {isRepaying && (
                <div className="flex items-center gap-3 text-orange-600">
                  ...
                  <span className="text-sm font-semibold">Processing repay request...</span>
                </div>
              )}
              ...
              {isRepaySuccess && (
                <div className="flex items-center gap-3 text-green-600">
                  ...
                  <span className="text-sm font-semibold">Repay successful!</span>
                </div>
              )}
              ...
              {isRepayError && (
                <div className="flex items-center gap-3 text-red-600">
                  ...
                  <span className="text-sm font-semibold">Repay failed</span>
                </div>
              )}
            </div>
