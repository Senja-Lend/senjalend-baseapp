...
export const MobilePoolCard = memo(function MobilePoolCard({
  ...
  return (
    <Card
      className={`w-full py-4 sm:py-1.5 max-w-xl mx-auto overflow-hidden border-0 bg-gradient-to-br from-orange-50/80 via-orange-100/60 to-pink-50/70 backdrop-blur-sm ring-1 ring-white/30 hover:shadow-2xl hover:ring-orange-200/50 transition-all duration-500 group ${
        clickable
          ? "hover:shadow-lg hover:bg-gradient-to-br hover:from-orange-100/80 hover:via-pink-50/70 hover:to-orange-50/80 cursor-pointer"
          : ""
      }`}
      onClick={handleClick}
    >
      <CardContent className="px-3 sm:p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {clickable && (
            <ArrowRight className="h-4 w-4 text-gray-400 flex-shrink-0 group-hover:text-orange-500 group-hover:translate-x-1 transition-all duration-300" />
          )}
        </div>
