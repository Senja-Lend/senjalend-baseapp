              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <p className="font-semibold text-senja-brown">{pool.collateralTokenInfo?.symbol}</p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Image
                      ...
                      className="rounded-full"
                    />
                    <p className="font-semibold text-senja-brown">{pool.borrowTokenInfo?.symbol}</p>
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-blue-600">{((Number(pool.ltv) / 1e16)).toFixed(1)}%</p>
                </div>
              </div>
            </Card>
